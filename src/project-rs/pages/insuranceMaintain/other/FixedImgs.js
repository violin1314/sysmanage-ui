...
class FixedImgs extends Component {
    ...
    render() {
        return(
            <div style={{ position: 'fixed', top: 10, right: 10, zIndex: 100, paddingTop: 36 }}>
                <Icon
                ...
                />
                <div style={{ width: 700, height: 540, overflowY: 'auto', background: '#fff', boxShadow: '0 0 10px #999', display: this.state.isToggle ? 'block' : 'none' }}>
