        ...
        return (
            <Form {...formItemLayout} onSubmit={ this.onSubmit } style={{ padding: 10, margin: 15, border: '1px solid #ddd' }}>
                <Row style={{ paddingBottom: 20 }}>
                    <Col span={8}>
                        <Form.Item label="医院名称">
                            {getFieldDecorator('medicalOrganization', {
                                ...
                                <ItemSelect
                                    label="医院"
                                    valueName="hospitalName"
                                    valueCode="hospitalCode"
                    ...
                    <Col span={8}>
                        <Form.Item label="是否自费住院">
                            {getFieldDecorator('isSelfVisit', {
                                initialValue: this.state.curVisit.isSelfVisit
                            })(
                                <Select allowClear placeholder="请选择是否自费住院" onChange={this.changeForm}>
                ...
                <Row style={{ textAlign: 'center' }}>
                    <Button type="primary" id="$button_visitQuery_other" onClick={ this.onSubmit }>确认</Button>
