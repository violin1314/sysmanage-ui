...
class ItemSelect extends Component {
    ...
    componentDidMount(){
        this.setState({
            ...
            searchDefault: this.props.searchDefault || undefined
        })
    ...
    UNSAFE_componentWillReceiveProps(nextProps){
        this.setState({
            ...
            url: nextProps.url,
            size: nextProps.size,
            searchDefault: nextProps.searchDefault || undefined
        })
                ...
                <Form layout="inline" style={{ marginBottom: 10 }}>
                    <Form.Item label="项目名称">
                        {getFieldDecorator('projectName', {
                            initialValue: this.state.searchDefault
                        })(
    ...
    getModalList = current => {
        ...
        if(this.state.valueName === 'hospitalName'){
            data['orgName'] = this.state.modalSearchValue;
        }else{
